...
public:
   ...
   */
  OneButton(PORT_t*const port, const int8_t pin, const bool activeLow, const bool pullupActive);
   ...
   */
  void setDebounceTicks(const unsigned int ticks);

  /**
   * set # millisec after single click is assumed.
   */
  void setClickTicks(const unsigned int ticks);

  /**
   * set # millisec after press is assumed.
   */
  void setPressTicks(const unsigned int ticks);
...
private:
  ...
  callbackFunction _clickFunc = 0;
  parameterizedCallbackFunction _paramClickFunc = 0;
  void *_clickFuncParam = 0;

  callbackFunction _doubleClickFunc = 0;
  parameterizedCallbackFunction _paramDoubleClickFunc = 0;
  void *_doubleClickFuncParam = 0;

  callbackFunction _multiClickFunc = 0;
  parameterizedCallbackFunction _paramMultiClickFunc = 0;
  void *_multiClickFuncParam = 0;

  callbackFunction _longPressStartFunc = 0;
  parameterizedCallbackFunction _paramLongPressStartFunc = 0;
  void *_longPressStartFuncParam = 0;

  callbackFunction _longPressStopFunc = 0;
  parameterizedCallbackFunction _paramLongPressStopFunc = 0;
  void *_longPressStopFuncParam = 0;

  callbackFunction _duringLongPressFunc = 0;
  parameterizedCallbackFunction _paramDuringLongPressFunc = 0;
  void *_duringLongPressFuncParam = 0;
